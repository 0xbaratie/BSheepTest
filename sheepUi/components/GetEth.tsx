			...
			<div className='w-80 flex flex-col gap-12 items-center justify-center'>
				...
				<div className='flex flex-col gap-2'>
					...
					<p className='text-sm text-white'>
						You will use ETH, the official currency of Base, to buy tiles and
						earn rewards
					</p>
				...
				<div className='text-sm'>
					Once there is GoerliETH in your wallet, you will get started with the
					rest of the app. We recommend at least 0.01 ETH.
				</div>
			</div>
		</div>
	)
